# Anhang D — Tabellen und Erläuterungen zu den Abbildungen

Alle Tabellen sind skriptgeneriert und unverändert aus `tables/` übernommen; die Skripte beschreibt Anhang A. Die Tabellennummern entsprechen den Verweisen im Text.

## D.1 Tabelle 1: Datenquellen und Indikatoren

Erzeugt von: `src/03_capture_ratio.py`
...
## D.2 Tabelle 2 — Capture Ratio: Sahel vs. übriges Subsahara-Afrika
...
## D.3 Tabelle 2b — Capture Ratio und menschliche Entwicklung
...
## D.4 Tabelle 3 — Robustheitsprüfungen
...
## D.5 Tabelle 4 — Datenabdeckung je Land (2000–2021)
...
## D.6 Erläuterungen zu den Abbildungen

**Abbildung 1.** Rohstoffrenten (% des BIP) im Jahr 2021 je Land der Region
...
**Abbildung 2.** Staatliche Abschöpfungsquote (Capture Ratio, zentriertes
...
**Abbildung 3.** Streudiagramm der Rohstoffrenten (WDI, % des BIP) gegen die
...
**Abbildung 4.** Staatliche Abschöpfungsquote (Capture Ratio) nach Periode und
Ländergruppe. Boxplots der Länder-Periodenmittel der zentriert dreijährig
geglätteten Quote; überlagerte Punkte zeigen die einzelnen Länder. Die Capture Ratio ist einheitenlos und gibt den Anteil der
...
**Abbildung 5.** Staatliche Abschöpfungsquote und menschliche Entwicklung
...
Zusammenhang *zwischen* Ländern; über die Entwicklung innerhalb der Länder
erlauben die Daten keine belastbare Aussage (vgl. Tab. 2b). Es handelt sich um
eine **Assoziation**, die keine Aussage über die Wirkungsrichtung erlaubt.
Quelle: World Bank WDI, UNU-WIDER GRD 2025, UNDP HDI; eigene Berechnung
